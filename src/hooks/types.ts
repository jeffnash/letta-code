...
// - Windows: Not currently supported. Hooks will fail with a clear error message.
//   Please use WSL or a POSIX-compatible shell on Windows.
//   TODO: Implement Windows support (PowerShell, exit code mapping, platform-specific tests)
