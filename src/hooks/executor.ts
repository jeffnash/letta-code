...
export async function executeHookCommand(
  ...
  // Windows compatibility: Hooks are not currently supported on Windows
  // TODO: Implement full Windows support (PowerShell, exit code mapping, tests)
  if (process.platform === "win32") {
    return {
      ...
      durationMs: 0,
      error:
        "Hooks are not supported on Windows. Please use WSL or a POSIX-compatible shell.",
    };
  }
